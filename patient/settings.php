            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                    ...
                    <td>
                        <p style="font-size: 23px;padding-left:12px;font-weight: 600;">Settings</p>
                            ...
                            <td width="15%">
                                <p style="font-size: 14px;color: rgb(10, 10, 10);padding: 0;margin: 0;text-align: right;">
                                    Today's Date
                                </p>
                    ...
                    <td colspan="4">
                        ...
                        <table class="filter-container" style="border: none;" border="0">
                            ...
                            <tr>
                                <td style="width: 25%;">
                                    ...
                                    <div  class="dashboard-items setting-tabs"  style="padding:20px;margin:auto;width:95%;display: flex">
                                        <div class="btn-icon-back dashboard-icons-setting" style="background-image: url('../img/user-setting.svg');background-size: 50%;"></div>
                                        <div>
                            ...
                            <td style="width: 25%;">
                                    ...
                                    <div  class="dashboard-items setting-tabs"  style="padding:20px;margin:auto;width:95%;display: flex;">
                                        <div class="btn-icon-back dashboard-icons-setting " style="background-image: url('../img//user-view.svg');background-size: 50%;"></div>
                                        <div>
                                                <div class="h1-dashboard" >
                            ...
                            <td style="width: 25%;">
                                    ...
                                    <div  class="dashboard-items setting-tabs"  style="padding:20px;margin:auto;width:95%;display: flex;">
                                        <div class="btn-icon-back dashboard-icons-setting" style="background-image: url('../img/delete-user.svg');background-size: 50%;"></div>
                                        <div>
