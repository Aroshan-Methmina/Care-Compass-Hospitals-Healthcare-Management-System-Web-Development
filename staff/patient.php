...
?>
                    ...
                    <td width="15%">
                        <p style="font-size: 14px;color: rgb(4, 3, 3);padding: 0;margin: 0;text-align: right;">
                            Today's Date
                        </p>
    ...
    if($_GET){
        ...
        $action=$_GET["action"];
            ...
            <div id="popup1" class="overlay">
                    <div class="popup" style="background-color: #006dd3; border-radius:30px; margin-Top:1%;">
                    <center>
