            ...
            <table class="menu-container" border="0"  style=" background-color:  #1980E1 ;">
                        ...
                        <table border="0" class="profile-container">
                            <tr>
                                <td width="40%" style="padding-left:20px" >
                                    <img src="../img/user1.svg" alt="" width="100%" style="border-radius:50%">
                                </td>
                                <td style="padding:0px;margin:0px;">
                                    <p class="profile-title">Administrator</p>
                                    <p class="profile-subtitle" style="color:white;">admin@gmail.com</p>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-result">
                        <a href="result.php" class="non-style-link-menu"><div><p class="menu-text">Report-Result</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-staff">
                        <a href="staff.php" class="non-style-link-menu"><div><p class="menu-text">Staff</p></a></div>
                    </td>
                </tr>
                </tr>
                <tr class="menu-row" >
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-message">
                        <a href="message.php" class="non-style-link-menu"><div><p class="menu-text">Message</p></a></div>
                    </td>
                </tr>
