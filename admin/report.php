            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; " >
                ...
                <tr >
                    <td colspan="2" style="padding-top:30px;">
                        <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">Add New Report</p>
                    </td>
                    <td colspan="2">
                                    ...
                                    echo '<tr>
                                            ...
                                            <td>
                                                <div style="display:flex;justify-content: center;">
                                                    <a href="?action=edit&id=' . $reportid . '&error=0" class="non-style-link"><button class="btn-primary-soft btn button-icon btn-edit" style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Edit</font></button></a>
                                                    &nbsp;&nbsp;&nbsp;
                                                    ...
                                                    &nbsp;&nbsp;&nbsp;
                                                    <a href="?action=drop&id=' . $reportid . '&name=' . $rname . '" class="non-style-link"><button class="btn-primary-soft btn button-icon btn-delete" style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Remove</font></button></a>
                                                </div>
                                            </td>
                                        </tr>';
                                    }
    ...
    <?php
        ...
        <div id="popup1" class="overlay">
                ...
                <center>
                    ...
                    <div class="content">
                        You want to delete this record<br>(' . substr($rnameget, 0, 40) . ').
                    </div>
                    <div style="display: flex;justify-content: center;">
                    ...
                    <a href="report.php" class="non-style-link"><button class="btn-primary btn" style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text">&nbsp;&nbsp;No&nbsp;&nbsp;</font></button></a>
                    </div>
                </center>
        </div>
        </div>
                ...
                echo '
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                <td>
                                    <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Add New Report.</p><br><br>
                                </td>
                            </tr>
                            
                            <tr>
                                <form action="add-report.php" method="POST" class="add-new-form">
                                <td class="label-td" colspan="2">
                                    <label for="rname" class="form-label">Report Name: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="rname" class="input-text" placeholder="Report Name" required><br>
                                </td>
                                
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="descripshion" class="form-label">Descripshion: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2" >
                                    <textarea  rows="6" cols="50" name="descripshion" class="input-text" placeholder="Descripshion" required >
                                    </textarea><br>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="price" class="input-text" placeholder="Prices" required><br>
                                </td>
                            </tr>
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Edit Report Details.</p>
                                        Report ID : '.$id.' (Auto Generated)<br><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <form action="edit-report.php" method="POST" class="add-new-form">
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="text" name="rname" class="input-text" placeholder="Report Name" value="'.$rname.'" required><br>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <textarea name="discription" class="input-text" placeholder="Enter Report Description" rows="4" required>'.$discription.'</textarea><br>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="text" name="price" class="input-text" placeholder="New Price" value="'.$price.'" required><br>
                                        </td>
