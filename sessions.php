                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                if($result->num_rows==0){
                                    ...
                                    <br>
                                    <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(15, 13, 13)">We  couldnt find anything related to your keywords !</p>
                                        ...
                                        <td style="width: 25%;">
                                                <div  class="dashboard-items search-items"  style="background-color:#FFFFFF;">
                                                    ...
                                                    <div style="width:100%">
                                                            ...
                                                            <div class="h3-search">
                                                                <br>price: RS.<b>'.substr($price,0,30).'
                                                            </div>
                                                            <br>
                                                            <a href="login.php" ><button  class="login-btn btn-primary-soft btn "  style="padding-top:11px;padding-bottom:11px;width:100%"><font class="tn-in-text">Book Now</font></button></a>
                                                    </div>
